...
class AddBorderSerializer(serializers.Serializer):
    ...
    left = serializers.CharField(required=True, allow_blank=False)
    top = serializers.CharField(required=True, allow_blank=False)
    right = serializers.CharField(required=True, allow_blank=False)
    bottom = serializers.CharField(required=True, allow_blank=False)
